...
#define COCOAPODS_POD_AVAILABLE_URBNSwipeableController
#define COCOAPODS_VERSION_MAJOR_URBNSwipeableController 0
#define COCOAPODS_VERSION_MINOR_URBNSwipeableController 1
#define COCOAPODS_VERSION_PATCH_URBNSwipeableController 0
